...
def main():
    ...
    parser.add_argument("-f","--data", help="input file contains hex values to write")
    parser.add_argument("-d","--hex", help="input hex values to write")
    ...
    if args.hex:
        ...
        data_size = len(data)
        print ("\nHex: " + binascii.hexlify(data) + "(size: " + str(data_size) + ")\n")
